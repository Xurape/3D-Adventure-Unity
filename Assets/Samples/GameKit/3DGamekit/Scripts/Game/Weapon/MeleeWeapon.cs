...
namespace Gamekit3D
{
    public class MeleeWeapon : MonoBehaviour
    {
        ...
        public bool isPlayerTheAttacker = false;
        ...
        private bool CheckDamage(Collider other, AttackPoint pts)
        {
            ...
            Debug.Log("Player is the attacker, giving damage to enemy!");

            if(!isPlayerTheAttacker) {
                Debug.Log("Player is not the attacker, giving damage to play!");
