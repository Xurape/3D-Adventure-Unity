...
[CreateAssetMenu(fileName = "InventoryItem_UltimateKey", menuName = "Inventory Items/UltimateKey", order = 1)]
public class InventoryItem_UltimateKey : InventoryItem, IUsableItem
{
